...
!function (a) {
    ...
    function p(n) {
        ...
        var e = s(n), t = e.data(d), i = s.proxy(f, n), r = o.unobtrusive.options || {};
        return t || (t = {
            options: {
                ...
                invalidHandler: function () {
                    !function (a, e) {
                        var n = s(this).find("[data-valmsg-summary=true]"), t = n.find("ul");
    ...
    return o.unobtrusive = {
        adapters: [], parseElement: function (t, a) {
            ...
            var a = s(a), e = a.parents().addBack().filter("form").add(a.find("form")).has("[data-val=true]");
        ...
        var i = {url: t.params.url, type: t.params.type || "GET", data: {}}, r = n(t.element.name);
